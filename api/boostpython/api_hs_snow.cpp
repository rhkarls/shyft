...
#include "core/hs_snow.h"

namespace expose {

    void hs_snow() {
        using namespace shyft::core::hs_snow;
        using namespace boost::python;
        namespace py = boost::python;
        using namespace std;
        class_<parameter>("HsSnowParameter")
        ...
        class_<response>("HsSnowResponse")
        ...
        typedef  calculator<parameter,state> HsSnowCalculator;
        class_<HsSnowCalculator>("HsSnowCalculator",
            ...
            .def("step",&HsSnowCalculator::step<response>,(py::arg("self"),py::arg("state"),py::arg("response"), py::arg("t0"), py::arg("t1"), py::arg("precipitation"), py::arg("temperature")),
