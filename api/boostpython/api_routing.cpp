...
namespace expose {
    ...
    void routing_ugh_parameter() {
        ...
        py::class_<routing::uhg_parameter>("UHGParameter",
          ...
          .def(py::init<py::optional<double,double,double>>(py::args("velocity","alpha","beta"),"a new object with specified parameters"))
        ...
        py::def("make_uhg_from_gamma",&routing::make_uhg_from_gamma,py::args("n_steps","alpha","beta"),
    ...
    void routing_river() {
        py::class_<routing::river>("River",
            ...
            .def("uhg",&routing::river::uhg,py::args("dt"),
    ...
    void routing_river_network() {
        ...
        py::class_<routing::river_network>("RiverNetwork",
            ...
            .def(py::init<const routing::river_network&>(py::args("clone"),"make a clone of river-network"))
            .def("add",&routing::river_network::add,py::args("river"),
            ...
            .def("remove_by_id",&routing::river_network::remove_by_id,py::args("id"),"disconnect and remove river for network")
            //.def("river_by_id",&routing::river_network::river_by_id2,args("id"),"get river by id")
            .def("river_by_id",griver,py::args("id"),"get river by id",py::return_internal_reference<>())
            .def("upstreams_by_id",&routing::river_network::upstreams_by_id,py::args("id"),"returns a list(vector) of id of upstream rivers from the specified one\n")
            .def("downstream_by_id",&routing::river_network::downstream_by_id,py::args("id"),"return id of downstream river, 0 if none")
            .def("set_downstream_by_id",&routing::river_network::set_downstream_by_id,py::args("id","downstream_id"),"set downstream target for specified river id")
